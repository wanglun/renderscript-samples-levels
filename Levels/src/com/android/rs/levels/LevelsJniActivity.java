...
public class LevelsJniActivity extends Activity
	...
	jniFilter(mInPixels, mOutPixels, m, mGamma, mInBlack, mOverInWMinInB, mOutWMinOutB,
		mOutBlack);
    ...
    public native void jniFilter(int[] InPixels, int[] OutPixels, float[] mm, float gamma, float InBlack, float OverInWMinInB, float OutWMinOutB, float OutBlack);
